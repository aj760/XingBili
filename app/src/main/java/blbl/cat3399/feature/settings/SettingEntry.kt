...
enum class SettingId(
    ...
    // 玩家体验
    FocusHintEnabled("focus_hint_enabled"),

    // 已看过记录
    WatchedBadgeUpMasterSpace("watched_badge_up_master_space"),
    WatchedBadgeOtherLists("watched_badge_other_lists"),
    ClearWatchedHistory("clear_watched_history"),
